...
BLOG_AUTHOR = "Numbersense"  # (translatable)
BLOG_TITLE = "NUMBERSENSE"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.numbersense.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.numbersense.io/"
BLOG_EMAIL = "info@numbersense.io"
BLOG_DESCRIPTION = "Numbersense's home on the internet."  # (translatable)
...
LOGO_URL = '/images/ns_green_small.png'
